...
const Button = styled.button`
  ...
  padding: 8px;
  border-radius: 4px;
  background: ${({disabled}) => (disabled ? "#989DA6" : "#A67153")};
  color: ${({disabled}) => (disabled ? "#F0F1F2" : "#F0F1F2")};
  border: none;
...
class CheckoutForm extends Component {
    ...
    handleSubmit = async event => {
        ...
        const amount = this.props.prixTotal * 100; // stripe donne le montant en centimes, donc * 100
